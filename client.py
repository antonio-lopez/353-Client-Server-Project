...
print("Recieved public key: ", server_string)
...
#encryptor = PKCS1_OAEP.new(server_string)
#server_public_key = RSA.importKey(server_string)
...
#server.sendall(("encrypted_message="+str(encrypted)).encode())
...
#         encyp_message = message_header + message
#         encrypted = server_public_key.encrypt(encyp_message, 32)
#         #client_socket.send(message_header + message)
#         client_socket.send("encrypted_message="+str(encrypted))
